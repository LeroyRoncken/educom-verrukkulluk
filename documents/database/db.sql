...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 02, 2025 at 09:26 AM
...
CREATE TABLE `article` (
  ...
  `price (cent)` int(11) NOT NULL,
  `packaging` int(11) NOT NULL,
  `unit` varchar(50) NOT NULL,
  `calories (kcal)` int(11) NOT NULL
...
INSERT INTO `article` (`id`, `name`, `description`, `image`, `price (cent)`, `packaging`, `unit`, `calories (kcal)`) VALUES

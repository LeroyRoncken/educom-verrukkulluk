...
(2, 'BBQ-pizza', 3, 4, 2, '2024-12-27', 'BBQ-pizza ai quattro formaggi. Met bier: het geheim van een krokante pizzabodem.', 'Een smaakvolle pizza met krokante bodem en de klassieke smaakcombinatie van kaas en tomaat.', 'https://static.ah.nl/static/recepten/img_RAM_PRD147605_1224x900_JPG.jpg'),
(3, 'Gevulde kaiserbroodjes', 5, 6, 1, '2024-12-16', 'Je kunt broodjes beleggen, maar je kunt ze ook vullen met ham en ei. Extra lekker!', 'Uitgeholde kaiserbroodjes gevuld met ei en ham. Lekker als ontbijt voor een speciale gelegenheid, maar ook gewoon zomaar natuurlijk!', 'https://static.ah.nl/static/recepten/img_118618_1224x900_JPG.jpg'),
...
(1, 'C', 1, 2, '2024-12-27', NULL, 'Cowabunga!'),
(2, 'S', 1, NULL, NULL, 1, 'Meng de bloem en baksoda in een kom.'),
(3, 'S', 1, NULL, NULL, 2, 'Voeg het ei en de karnemelk toe en mix met een handmixer tot een glad beslag.'),
(4, 'S', 1, NULL, NULL, 3, 'Snijd de fudge in blokjes, voeg toe en meng goed door elkaar.'),
(5, 'S', 1, NULL, NULL, 4, 'Verwarm het wafelijzer en schenk een flinke eetlepel beslag in de vorm. Bak de wafels ca. 2 minuten tot ze goudbruin zijn. Herhaal tot het beslag op is.'),
(6, 'S', 1, NULL, NULL, 5, 'Serveer de wafels met een bol vanille-ijs. Ook lekker met extra karamel- of fudgesaus.'),
(7, 'S', 2, NULL, NULL, 1, 'Verwarm het bier in een steelpan tot lauwwarm. Meng de bloem in een kom met de gist. Schenk het bier erbij en kneed met de mixer met deeghaken. Voeg de honing en het zout toe en kneed verder tot een stevig deeg. Maak er een bal van, bestuif licht met bloem en leg terug in de kom. Dek af met vershoudfolie en laat 2 uur rijzen.'),
(8, 'S', 2, NULL, NULL, 2, 'Kneed het deeg nogmaals door. Verdeel in 4 bolletjes en dek af met een schone theedoek. Laat nog 30 min. rijzen.'),
(9, 'S', 2, NULL, NULL, 3, 'Steek ondertussen de barbecue aan. Verhit tot 250-300 °C. Leg de pizzasteen op het rooster, zodat die ook goed heet wordt.'),
(10, 'S', 2, NULL, NULL, 4, 'Rol een bolletje deeg zo dun mogelijk uit tot een lap van Ø 22 cm. Bestrijk met ¼ van de pizzasaus. Rasp ¼ van de Parmezaanse kaas erboven. Scheur de mozzarella in stukjes en verdeel ¼ samen met ¼ van de ricotta en ¼ van de gorgonzola over de pizza. Ris de blaadjes van de takjes tijm en strooi ¼ erover.'),
(11, 'S', 2, NULL, NULL, 5, 'Leg de pizza met behulp van de pizzaschep of springvormbodem op de hete pizzasteen. Doe de deksel op de barbecue en bak de pizza in 8 min. knapperig. Doe de deksel op de barbecue en bak de pizza in 8 min. knapperig. Snijd in 8 punten en serveer. Maak zo nog 3 pizza’s.'),
(12, 'C', 2, 1, NULL, NULL, 'Righteous!'),
(13, 'C', 2, 2, NULL, NULL, 'Acca pella!'),
(14, 'C', 2, 3, NULL, NULL, 'Cowabunga!'),
(15, 'C', 2, 4, NULL, NULL, 'Radical!'),
(16, 'S', 3, NULL, NULL, 1, 'Verwarm de oven voor op 160 °C. Snijd van de bovenkant van de broodjes een cirkel van ca. 8 cm af. Hol de broodjes vanbinnen zo veel mogelijk uit. De kapjes en de inhoud worden niet meer gebruikt.'),
(17, 'S', 3, NULL, NULL, 2, 'Bekleed de binnenkant van de broodjes met de ham. Zet de broodjes op de bakplaat. Breek in elk broodje een ei. Zet de broodjes ca. 25 min. onder in de oven. Het eiwit is nu gestold, het eigeel nog niet.'),
(18, 'S', 3, NULL, NULL, 3, 'Knip ondertussen de bieslook fijn. Bestrooi de broodjes met de bieslook.'),
(19, 'S', 4, NULL, NULL, 1, 'Zorg ervoor dat de satéprikkers 30 min. zijn geweekt in water. Verwarm de oven voor op 180 °C. Rol het bladerdeeg uit en leg het bakpapier op een bakplaat.'),
(20, 'S', 4, NULL, NULL, 2, 'Halveer het deeg in de breedte. Beleg 1 helft met de kaas en dek af met de andere helft bladerdeeg. Snijd het gestapelde deeg in de lengte in 8 repen (per 8 stuks).'),
(21, 'S', 4, NULL, NULL, 3, 'Vouw de repen, al zigzaggend en van onder naar boven in steeds smallere slagen, tot kerstboompjes en leg ze op het bakpapier.'),
(22, 'S', 4, NULL, NULL, 4, 'Steek in elk boompje van onder naar boven een satéprikker en laat deze 1 cm uitsteken.'),
(23, 'S', 4, NULL, NULL, 5, 'Bak in het midden van de oven in ca. 20 min. gaar. Neem uit de oven. Besmeer de boompjes met de pesto en bak nog ca. 2 min. Steek cherrytomaten als piek boven op de prikkers en serveer.'),
(24, 'C', 3, 1, NULL, NULL, 'Shell shocked!'),
(25, 'C', 3, 3, NULL, NULL, 'Booyakasha!'),
(27, 'C', 1, 4, NULL, NULL, 'Every turtle for himself!');
